...
Constants.GET_COMMUNITY_FOR_USER = "SELECT CommunityName, CommunityID FROM " + Constants.DB_SCHEMA.TABLES.COMMUNITIES + " WHERE communityID IN (SELECT community_id FROM " + Constants.DB_SCHEMA.TABLES.COMMUNITYUSERS + " WHERE email = ?)";
